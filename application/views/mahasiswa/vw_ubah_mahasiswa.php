                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select name="jenis kelamin" id="jenis_kelamin" class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="no_hp" class="form-control" value="<?= $mahasiswa['no_hp']; ?>" id="asal_sekolah" placeholder="No HP">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="alamat" class="form-control" value=" <?= $mahasiswa['alamat']; ?>" id="alamat" placeholder="Alamat">
